...
public class TypeChecker {
	...
	//variabile che dice se è concesso chiamare un assert
	...
	//metodo per la creazione di un typechecker apposito per i test (dove sono ammessi gli assert)
	...
	//dice se è concesso l'assert. Solo nei test
